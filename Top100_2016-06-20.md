语言|star|项目名称|描述
---|---|---|---
Java|49|[u3shadow/RemoveButterKnife](https://github.com/u3shadow/RemoveButterKnife)|An Android Studio plugin to help remove use of ButterKnife
Python|26|[tmadl/highdimensional-decision-boundary-plot](https://github.com/tmadl/highdimensional-decision-boundary-plot)|Heuristic approach to plotting the decision boundary (decision surface) of machine learning classifiers in higher dimensions
GLSL|18|[nicoptere/BUMP](https://github.com/nicoptere/BUMP)|list of shaders for the Bump festival
Swift|17|[LitleCarl/LiveLabel](https://github.com/LitleCarl/LiveLabel)|Dynamic gradient label and Lyric label for iOS
...
JavaScript|14|[fullstackio/cq](https://github.com/fullstackio/cq)|extract code snippets using selectors (instead of line numbers)
Python|12|[umutcoskun/mirket](https://github.com/umutcoskun/mirket)|Get social network stats for a URL.
...
Java|7|[YucelT94/FriendlyChat](https://github.com/YucelT94/FriendlyChat)|Basicly chat app using firebase (Google Firebase Android Codelab)
 |6|[masui/Block8008](https://github.com/masui/Block8008)|1977年ごろ書いた8008マイコンのブロック崩し
...
Java|6|[vvinner/BadgeView](https://github.com/vvinner/BadgeView)|在任何View上添加红点
...
Ruby|6|[m0nad/HellRaiser](https://github.com/m0nad/HellRaiser)|Vulnerability Scanner
...
C#|4|[slonermike/SloneDB](https://github.com/slonermike/SloneDB)|SQLite Local Database Wrapper for Unity
Go|4|[coreos/gofail](https://github.com/coreos/gofail)|failpoints for go
...
Java|4|[dalong982242260/CardVoucher](https://github.com/dalong982242260/CardVoucher)|卡券常用的锯齿布局
JavaScript|4|[cyclejs-community/boids](https://github.com/cyclejs-community/boids)|Boids in Cycle.js (bird flocking simulator)
JavaScript|4|[rwu823/delegate-to](https://github.com/rwu823/delegate-to)|DOM Event delegate, it works great in React, too
...
JavaScript|3|[karissa/yolowatch](https://github.com/karissa/yolowatch)| 
...
PHP|3|[mpociot/laravel-firebase-sync](https://github.com/mpociot/laravel-firebase-sync)|Synchronize your Eloquent models with a Firebase Realtime Database.
...
Swift|2|[gongxiaosan/GXViewController](https://github.com/gongxiaosan/GXViewController)|swift 仿网易新闻控件 scrollView
Swift|2|[qutheory/ssl](https://github.com/qutheory/ssl)|Swift OpenSSL wrapper
...
Swift|2|[norio-nomura/SwiftLintForXcode](https://github.com/norio-nomura/SwiftLintForXcode)|a sample of Xcode Extension that runs `swiftlint autocorrect`
 |2|[WhiskeyJack96/ProjectPinocchio](https://github.com/WhiskeyJack96/ProjectPinocchio)| 
